...
#Import REDCAP data
Data <- read_excel("2024_07_02_DataREDCAP.xlsx")
...
Master <- Master %>%
  rename( REDCAP_SEQ_NO = part_id,
          ...
          V1_SpuCuL_Text = ea_exp_micro_res,
          V2_Antibiotic_treament = v2_antibio,
          V2_SpuCul_Text = ea_exp_micro_res_v2,
...
Master <- Master[,c(1:6,394,395,7:393)]
...
Master <- Master[,c(1:101,343:366,102:342)]
...
Master <- Master[,c(1:149,327:346,150:326)]
...
Master <- Master[,c(1:180,311:316,181,317:328,182:310)]
...
Master <- Master[,c(1:206,313:320,207:312)]
